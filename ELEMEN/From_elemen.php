...
define('MAX_UNIT_PER_UNIT', 10);

$count_sql = "SELECT COUNT(*) as total FROM tb_elemen WHERE id_unit = ?";
$count_stmt = mysqli_prepare($koneksi, $count_sql);
mysqli_stmt_bind_param($count_stmt, "i", $id_unit);
...
$is_max_reached = ($current_unit_count >= MAX_UNIT_PER_UNIT);
        ...
        <div class="form-container">
            <form method="post" action="" id="formUnit">
                ...
                <div class="button-group">
                    <a href="../BERANDA/UTAMA.php?page=../UNIT/unit_kompetensi.php" class="btn btn-secondary">
